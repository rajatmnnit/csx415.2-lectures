...
- Data Scientist in the Bay Area since 2013 at
  ...
  + Verisk Analytics (right here in downtown)
  + GE Digital
  + Unitedhealthcare
...
![](https://copower.com/wp-content/uploads/unitedhealth.png)
]
---
### Why are you here?
...
- Weekly lectures and discussions (in bite-sized chunks)
  + There may be multiple slide decks for each lecture (e.g. labeled Session_1.1, Session_1.2, etc.)

- In class exercises - bring your laptops

- Weekly homeworks (7 in total)

- Take home midterm (basically like a homework assignment)

- Take home final (basically another homework assignment, but comprehensive)
...
- Weekly homeworks (7 in total) **individual**

- Take home midterm (basically like a homework assignment) **individual**

- Take home final (basically another homework assignment, but comprehensive) **individual**
...
- Feel free to discuss homework problems with each other, but all code and writing must have been completed by you. Do NOT share code.  
...
Attendance is expected and mandatory. If you have any concerns, please see me.

Criterion 1 (Homework) – 30% (Lowest score will be dropped)  
