...
- Weekly lectures and discussions for first two hours (in bite-sized chunks)
  + There may be multiple slide decks for each lecture (e.g. labeled Session_1.1, Session_1.2, etc.)

- Weekly homeworks/labs (7 in total)
  + To be started in-class during last hour - bring your laptops
...
- Weekly homeworks/labs (7 in total) **individual**
  + To be started in-class during last hour - bring your laptops
  + Due on Tuesday of the following week
...
- Feel free to discuss homework/lab problems with each other, but all code and writing must have been completed by you. Do NOT share code.  
...
Criterion 1 (Homework/Labs) – 30% (Lowest score will be dropped)  
