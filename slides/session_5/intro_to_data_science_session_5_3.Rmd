...
Look at the `faithful` data set and ask yourself: are there other variables that might affect this pattern? If so, make a plot that reveals the reason for the pattern seen in this histogram. What is the reason?
